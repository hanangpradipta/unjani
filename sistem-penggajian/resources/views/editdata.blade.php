...
<div class="judultambah"><h1>Silahkan edit data karyawan</h1></div>
<div class="pusatcontenttambah">
  ...
  @endif
  <form method="post" action="/admins/new/{{$admins->id}}">
    
    @csrf
    <div class="mb-3">
      <label for="nama" class="form-label">Nama</label>
      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nama" value="{{$admins->nama}}" requeired>
    </div>
    <div class="mb-3">
      <label for="nip" class="form-label">NIP</label>
      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nip"value="{{$admins->nip}}" requeired>
    </div>
    <div class="mb-3">
      <label for="alamat" class="form-label">Alamat</label>
      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="alamat" value="{{$admins->alamat}}" required>
    <div class="mb-3">
      <label for="golongan" class="form-label">Golongan</label>
      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="golongan" value="{{$admins->golongan}}" requeired>
    </div>
    <div class="mb-3">
      <label for="password" class="form-label">Password</label>
      <input type="password" class="form-control" id="exampleInputPassword1" name="password" value="{{$admins->password}}" requeired>
    </div>
    <button type="submit" class="btn btn-primary btn-submit">Perbarui</button>
    <a href="/admins/edit/" class="btn btn-outline-danger btn-submit datakar">Batalkan</a>
  </form>
</div>
</body>
</html>